...
//TODO:: Generalize to one super class
//Requires quite a lot of refactoring work
//All of the dropdown views / Overlays can be generalized to one class
//But it requires smart passing of inner components (Modals) with
//callback functions as properties

export const AdditionalEducationOverlay = (props) => {
        ...
        <View style={profileStyles.dropdownModalContainer}>
            <Text style={{fontSize: 22}}>LISÄÄ KOULUTUS</Text>
                ...
                {dataList.map((val, idx) => {
                    return(
                        <AdditionalEducationOverlayImmutable 
                            key={idx}
                            data={val}
...
export const AdditionalEducationOverlayImmutable = (props) => {
    return(
...
export const AdditionalEducationModal = (props) => {
