...
const SearchResults = () => {
  ...
  const searchResultPages = indexSearchResultPages(searchResults.length, itemsPerPage)
  ...
  const renderSearchResults = useCallback(() => {
    ...
    let slicedResults = searchResults.slice(startPage, startPage + itemsPerPage)
  ...
  return (
    <ScrollView>
      <View style={ [ Styles.container, { alignItems: 'center', justifyContent: 'flex-start' } ] }>
        <Text>Löydettiin { searchResults.length } avointa työpaikkaa</Text>
        { renderSearchResults() }
